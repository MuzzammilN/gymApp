  ...
  return (
    ...
    max-w-[900px] w-full mx-auto'>
      ...
      <p className='text-sm md:text-base font-light'>I hereby acknowledgement that I may become 
        ...
        <span className='text-blue-400 font-medium'> mass montrosity</span>, afflicted 
        with severe body dismorphia, unable to 
        fit through doors.</p>

        <button className=' rounded-md border-[2px] bg-slate-950 border-blue-400 border-solid blueShadow sm:px-8 py-2 sm:py-4 relative duration-200'>
      <p>Accept & Begin</p>
        </button>
